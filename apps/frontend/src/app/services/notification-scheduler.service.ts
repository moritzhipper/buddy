...
import { selectAppointments, selectSettings, selectTherapists } from '../store/buddy.selectors'
...
export class NotificationSchedulerService {
   ...
   appointments$: Observable<Appointment[]> = this._store.select(selectAppointments)
   ...
   constructor(private _store: Store<BuddyState>, private _notificationService: NotificationService) {
