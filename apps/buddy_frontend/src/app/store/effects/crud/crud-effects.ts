...
export class CrudEffects {
   ...
   // goals
   private goalFX = new CrudEffectsGenerator(
      goalActions,
      this.backendAdapter.ROUTE_GOALS
   );
   ...
   // notes
   private noteFX = new CrudEffectsGenerator(
      noteActions,
      this.backendAdapter.ROUTE_NOTES
   );
   ...
   // therapist
   private therapistFX = new CrudEffectsGenerator(
      therapistActions,
      this.backendAdapter.ROUTE_THERAPIST
   );
   ...
   // appointments
   private appointmentFX = new CrudEffectsGenerator(
      appointmentActions,
      this.backendAdapter.ROUTE_APPOINTMENT
   );
